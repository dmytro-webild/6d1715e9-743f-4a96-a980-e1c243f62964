  ...
  <div id="fleet" data-section="fleet">
      ...
      products={[
        ...
        },
        {
          ...
          price: "High Spec",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/billboard-template-urban-environment_23-2148197204.jpg",
        },
        {
          id: "p3",
          brand: "Thermo King",
          ...
          price: "High Spec",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/scene-with-photorealistic-logistics-operations-proceedings_23-2151468885.jpg",
        },
        {
          id: "p4",
          brand: "Freightliner",
        ...
        },
        {
          ...
          price: "High Spec",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/cargo-trucks-shipping-containers-sunset-port_23-2151998716.jpg",
        },
        {
          id: "p6",
          brand: "Thermo King",
      ...
      testimonials={[
        {
          ...
          name: "James R.",
          role: "Senior Driver",
          testimonial: "UTLogistics provides the most stable routes I've ever had on the Amazon Relay platform.",
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-middle-aged-bearded-trucker-standing-front-truck-trailer-against-grey-shiny-tarpaulin_342744-1308.jpg",
        },
        {
          id: "t2",
          name: "Sarah K.",
          role: "Dispatcher",
          testimonial: "The TMS tools provided here are lightyears ahead of my previous dispatch firm.",
        ...
        },
        {
          ...
          name: "Marcus L.",
          role: "Owner-Operator",
          testimonial: "Consistent weekly gross and zero hassle with payment cycles. Highly recommended.",
          imageSrc: "http://img.b2bpic.net/free-photo/truck-driver-inspecting-truck-long-vehicle-before-driving_342744-1311.jpg",
        },
        {
          id: "t4",
          name: "Elena V.",
          role: "Trucking Fleet Manager",
          testimonial: "Professional support team that actually understands the complexities of freight.",
        ...
        },
        {
          ...
          testimonial: "Excellent home time flexibility. They really care about the drivers here.",
          imageSrc: "http://img.b2bpic.net/free-photo/man-working-as-truck-driver_23-2151489795.jpg",
        },
      ]}
    />
  </div>
